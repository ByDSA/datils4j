...
public class ListMapTest {
    ...
    public static class SampleStatus {
        ...
        public void initTest() {
            ...
            assertEquals(new Pair<>("2x1", 2), listMap.get(0));
            assertEquals(new Pair<>("2x2", 4), listMap.get(1));
            assertEquals(new Pair<>("2x3", 6), listMap.get(2));
            assertEquals(new Pair<>("2x4", 8), listMap.get(3));
            assertEquals(new Pair<>("1+1", 2), listMap.get(4));
        }
        ...
        public void lastIndexOf() {
            assertEquals(4, listMap.lastIndexOf(new Pair<>("1+1", 2)));
        }

        @Test
        public void lastIndexOfNotFound() {
            assertEquals(-1, listMap.lastIndexOf(new Pair<>("1+2", 3)));
        }
    ...
    public static class Iterator {
        public static class First {
            ...
            @Test
            public void next() {
                assertEquals(new Pair<>("2x1", 2), listMapIterator.next());
            }
            ...
            @Test
            public void add() {
                listMapIterator.add(new Pair<>("2+2", 4));
                assertEquals(new Pair<>("2+2", 4), listMap.get(0));
            }

            @Test(expected = IllegalStateException.class)
            public void set() {
                listMapIterator.set(new Pair<>("2", 2));
            }
        }
        ...
        public static class AfterNext {
            ...
            public void remove() {
                listMapIterator.remove();
                assertEquals(4, listMap.size());
                assertEquals(new Pair<>("2x2", 4), listMap.get(0));
            }
            ...
            public void add() {
                listMapIterator.add(new Pair<>("2+2", 4));
                assertEquals(6, listMap.size());
                assertEquals(new Pair<>("2+2", 4), listMap.get(1));
            }
            ...
            public void set() {
                listMapIterator.set(new Pair<>("2", 2));
                assertEquals(5, listMap.size());
                assertEquals(new Pair<>("2", 2), listMap.get(0));
            }
        }
        ...
        public static class Last {
            ...
            @Test
            public void previous() {
                assertEquals(new Pair<>("1+1", 2), listMapIterator.previous());
            }
            ...
            public void remove() {
                listMapIterator.remove();
                assertEquals(4, listMap.size());
                assertEquals(new Pair<>("2x4", 8), listMap.get(listMap.size() - 1));
            }
            ...
            public void add() {
                listMapIterator.add(new Pair<>("2+2", 4));
                assertEquals(6, listMap.size());
                assertEquals(new Pair<>("2+2", 4), listMap.get(listMap.size() - 1));
            }
            ...
            public void set() {
                listMapIterator.set(new Pair<>("2", 2));
                assertEquals(5, listMap.size());
                assertEquals(new Pair<>("2", 2), listMap.get(listMap.size() - 1));
            }
        }
    }
}